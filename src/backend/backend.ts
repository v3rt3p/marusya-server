...
export type AliceDirective = object
...
export abstract class AudioMetadataBackendSession {
  ...
  abstract processChunk (chunk: Buffer, format: string): Promise<void>
}
...
export abstract class STTBackendSession {
  ...
  abstract transcribeChunk (chunk: Buffer, format: string): Promise<void>
